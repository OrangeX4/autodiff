...
self.executor_map = {
    'c': {
        'Windows': Executor('gcc {file} -o {fileNoExtension}.exe',
                            '{fileNoExtension}.exe'),
        'Linux': Executor('gcc {file} -o {fileNoExtension}',
                            './{fileNoExtension}')
    },
    'cpp': {
        'Windows': Executor('g++ "{file}" -o "{fileNoExtension}.exe"',
                            '{fileNoExtension}.exe'),
        'Linux': Executor('g++ "{file}" -o "{fileNoExtension}.out"',
                            '{fileNoExtension}.out')
    },
    'py': {
